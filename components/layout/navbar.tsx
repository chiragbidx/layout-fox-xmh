...
const featureList: FeatureProps[] = [
  {
    title: "App Router & Teams",
    description: "Production-ready boilerplate: Next.js 16, TypeScript, Drizzle, Postgres, multi-tenant teams."
  },
  {
    title: "Design System & Theme",
    description: "Shadcn-based components, dark mode, and utility-first styling out of the box.",
  },
  {
    title: "Deploy & Launch Fast",
    description: "Opinionated setup for Vercel, Railway, and instant developer flow.",
  },
];
